...
#define Size 10  											  //缓存区长度
#define FLASH_SAVE_ADDR  0X08006000			//Flash写入起始地址
//OLED模式设置
//0:4线串行模式
//1:并行8080模式
#define OLED_MODE 0
...
void OLED_DecimalShow(u8 x,u8 y,float num,u8 lenz,u8 lenx,u8 size);  //小数显示函数
void OLED_ShowCursor(u8 x,u8 y);  //显示光标
