...
// 	
// 	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOC, ENABLE);	 //使能PC,D,G端口时钟

//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_2|GPIO_Pin_9|GPIO_Pin_13|GPIO_Pin_15;	 //PD3,PD9推挽输出  
// 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
// 	GPIO_Init(GPIOB, &GPIO_InitStructure);	  //初始化GPIOD3,9
//	GPIO_Init(GPIOA, &GPIO_InitStructure);	  //初始化GPIOD3,9
//	GPIO_Init(GPIOC, &GPIO_InitStructure);	  //初始化GPIOD3,9
// 	GPIO_SetBits(GPIOA,GPIO_Pin_0);	//PD3,PD9 输出高
//	GPIO_SetBits(GPIOB,GPIO_Pin_9);	//PD3,PD9 输出高
//	GPIO_SetBits(GPIOB,GPIO_Pin_15|GPIO_Pin_13);	//PD3,PD9 输出高
...
{ 
	...
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_4|GPIO_Pin_1|GPIO_Pin_10|GPIO_Pin_11;//KEY1-KEY4
